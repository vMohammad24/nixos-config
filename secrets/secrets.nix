...
in {
  ...
  "cloudflared-atums.age".publicKeys = [vmohammad server];
  "cloudflare-dns-api-token.age".publicKeys = [vmohammad server];
  ...
  "searx-secret-key.age".publicKeys = [vmohammad server];
