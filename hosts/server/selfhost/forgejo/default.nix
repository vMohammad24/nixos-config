{
  ...
  options.myConfig.forgejo-runner.enable = lib.mkEnableOption "forgejo runner";

  config = lib.mkIf config.myConfig.forgejo-runner.enable {
    networking.firewall.allowedTCPPorts = [3300 3301];
